...
//! (IdentityStore, GroupStore, CredentialStore, etc.) are parameterized on a
...
//! - Future: column family, table name, etc.
//!
//! ## Iterator invariant
//!
...
// ============================================================================
// In-Memory Backend (test double + reference implementation)
// ============================================================================
